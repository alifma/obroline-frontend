          ...
          <div class="card-body">
            ...
            <form @submit.prevent="register()" action="" class="mt-4">
              <div class="form-group mb-4">
                ...
                <input required type="text" v-model="holderRegister.name"
              ...
              <div class="form-group mb-4">
                ...
                <input required type="email" v-model="holderRegister.email"
                  class="px-0 font-weight-bold form-control border-top-0 border-left-0 border-right-0"
                  style="border-bottom:2px solid black" value="obroline@gmail.com">
              </div>
              <div class="form-group mt-4">
                <label class="text-secondary">Password</label>
                <input required type="password" value="password" v-model="holderRegister.password"
                  class="px-0 font-weight-bold form-control border-top-0 border-left-0 border-right-0"
            ...
            <button class="btn btn-sub w-100 font-weight-bold my-3"
              @click="swalAlert('Coming Soon', 'You will be able to Sign-Up with your google account', 'info')"
